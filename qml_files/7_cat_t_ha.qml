    ...
    <rasterrenderer nodataColor="" classificationMin="-472.3543091" type="singlebandpseudocolor" band="1" classificationMax="39.6022987" alphaBand="-1" opacity="1">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" minimumValue="-472.35430910000002" clip="0" maximumValue="39.602298699999999" labelPrecision="4" classificationMode="2">
          ...
          <item label="&lt; -5 [t/ha]" alpha="255" color="#ff5500" value="-0.5"/>
          <item label="-5 ~ -1 [t/ha]" alpha="255" color="#ffaa00" value="-0.1"/>
          <item label="-1 ~ -0,01 [t/ha]" alpha="255" color="#ffffbe" value="-0.01"/>
          <item label="-0,01 ~ 0,01 [t/ha]" alpha="255" color="#ffffff" value="0.01"/>
          <item label="-0,01 ~ 1 [t/ha]" alpha="255" color="#bee8ff" value="0.1"/>
          <item label="1 ~ 5 [t/ha]" alpha="255" color="#0070ff" value="0.5"/>
          <item label="> 5 [t/ha]" alpha="255" color="#002673" value="inf"/>
