    ...
    <rasterrenderer nodataColor="" classificationMin="-472.3543091" type="singlebandpseudocolor" band="1" classificationMax="39.6022987" alphaBand="-1" opacity="1">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" minimumValue="-472.35430910000002" clip="0" maximumValue="39.602298699999999" labelPrecision="4" classificationMode="2">
          ...
          <item label="&lt; -1 [kg/m2]" alpha="255" color="#e60000" value="-1"/>
          <item label="-1 ~ -0,5 [kg/m2]" alpha="255" color="#ff5500" value="-0.5"/>
          <item label="-0,5 ~ -0,1 [kg/m2]" alpha="255" color="#ffd37f" value="-0.1"/>
          <item label="-0,01 ~ -0,001 [kg/m2]" alpha="255" color="#ffffbe" value="-0.001"/>
          <item label="-0,001 ~ 0,001 [kg/m2]" alpha="255" color="#ffffff" value="0.001"/>
          <item label="0,001 ~ 0,1 [kg/m2]" alpha="255" color="#d3ffbe" value="0.1"/>
          <item label="0,1 ~ 0,5 [kg/m2]" alpha="255" color="#98e600" value="0.5"/>
          <item label="0,5 ~ 1 [kg/m2]" alpha="255" color="#0084a8" value="1"/>
          <item label="> 1 [kg/m2]" alpha="255" color="#004da8" value="inf"/>
